...
namespace SpreadsheetSimulatorConsoleApp.Tests
{
    public class DivideExpressionTests
    {
        ...
        public void InterpretDivideNumbersCorrectly()
        {
            ...
            context.SetExpression(new ExpressionVariable("A1", new NumberExpressionValue(15)));
            context.SetExpression(new ExpressionVariable("A2", new NumberExpressionValue(5)));
