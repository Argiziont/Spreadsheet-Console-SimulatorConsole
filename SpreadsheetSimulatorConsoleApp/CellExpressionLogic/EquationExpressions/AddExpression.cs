...
namespace SpreadsheetSimulatorConsoleApp.CellExpressionLogic.EquationExpressions
{
    public class AddExpression : IExpression
    {
        ...
        {            
            if (_leftExpression.Interpret(expressionContext) is NumberExpressionValue leftExpression && _rightExpression.Interpret(expressionContext) is NumberExpressionValue rightExpression)
            {
